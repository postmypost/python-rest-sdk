...
class TestInitUploadRequestOneOf(unittest.TestCase):
    """InitUploadRequestOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitUploadRequestOneOf:
        """Test InitUploadRequestOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitUploadRequestOneOf`
        """
        model = InitUploadRequestOneOf()
        if include_optional:
            return InitUploadRequestOneOf(
                project_id = 56,
                url = ''
            )
        else:
    ...
    def testInitUploadRequestOneOf(self):
        """Test InitUploadRequestOneOf"""
