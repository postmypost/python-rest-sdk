...
class TestUploadInitOneOf(unittest.TestCase):
    """UploadInitOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadInitOneOf:
        """Test UploadInitOneOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadInitOneOf`
        """
        model = UploadInitOneOf()
        if include_optional:
            return UploadInitOneOf(
                id = 1283466,
                name = 'test.jpg',
