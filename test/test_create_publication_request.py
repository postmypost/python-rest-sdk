...
class TestCreatePublicationRequest(unittest.TestCase):
    """CreatePublicationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePublicationRequest:
        """Test CreatePublicationRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePublicationRequest`
        """
        model = CreatePublicationRequest()
        if include_optional:
    ...
    def testCreatePublicationRequest(self):
        """Test CreatePublicationRequest"""
