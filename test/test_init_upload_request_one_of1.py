...
class TestInitUploadRequestOneOf1(unittest.TestCase):
    """InitUploadRequestOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitUploadRequestOneOf1:
        """Test InitUploadRequestOneOf1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitUploadRequestOneOf1`
        """
        model = InitUploadRequestOneOf1()
        if include_optional:
            return InitUploadRequestOneOf1(
                project_id = 56,
                name = '',
                size = 56
            )
    ...
    def testInitUploadRequestOneOf1(self):
        """Test InitUploadRequestOneOf1"""
