...
class TestRubricsResponse(unittest.TestCase):
    """RubricsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RubricsResponse:
        """Test RubricsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RubricsResponse`
        """
        model = RubricsResponse()
        if include_optional:
            return RubricsResponse(
                data = [
                    postmypost_rest_sdk.models.rubric.Rubric(
                        id = 17289, 
                        name = 'News', )
                    ],
