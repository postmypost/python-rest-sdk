...
class TestAccountAnalyticsResponse(unittest.TestCase):
    """AccountAnalyticsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountAnalyticsResponse:
        """Test AccountAnalyticsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountAnalyticsResponse`
        """
        model = AccountAnalyticsResponse()
        if include_optional:
            return AccountAnalyticsResponse(
                data = [
                    postmypost_rest_sdk.models.account_analytics.AccountAnalytics(
                        type = 'followers', 
                        title = 'Followers', 
                        data = [
    ...
    def testAccountAnalyticsResponse(self):
        """Test AccountAnalyticsResponse"""
