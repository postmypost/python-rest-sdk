...
class TestPublicationStatusEnumEdit(unittest.TestCase):
    """PublicationStatusEnumEdit unit test stubs"""
    ...
    def testPublicationStatusEnumEdit(self):
        """Test PublicationStatusEnumEdit"""
        # inst = PublicationStatusEnumEdit()
