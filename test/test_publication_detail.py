...
class TestPublicationDetail(unittest.TestCase):
    """PublicationDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicationDetail:
        """Test PublicationDetail
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicationDetail`
        """
    ...
    def testPublicationDetail(self):
        """Test PublicationDetail"""
