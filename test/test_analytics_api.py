...
class TestAnalyticsApi(unittest.TestCase):
    ...
    def test_get_analytics_accounts(self) -> None:
        """Test case for get_analytics_accounts

        Get account analytics
        """
        pass

    def test_get_analytics_publications(self) -> None:
        """Test case for get_analytics_publications
