...
class TestUpdatePublicationRequest(unittest.TestCase):
    """UpdatePublicationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePublicationRequest:
        """Test UpdatePublicationRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePublicationRequest`
        """
        model = UpdatePublicationRequest()
        if include_optional:
            return UpdatePublicationRequest(
                ...
                details = [
                    postmypost_rest_sdk.models.publication_detail_edit_request.PublicationDetailEditRequest(
                        account_id = 4, 
                        publication_type = 1, 
    ...
    def testUpdatePublicationRequest(self):
        """Test UpdatePublicationRequest"""
