...
class TestUploadInitOneOf1(unittest.TestCase):
    """UploadInitOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UploadInitOneOf1:
        """Test UploadInitOneOf1
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UploadInitOneOf1`
        """
        model = UploadInitOneOf1()
        if include_optional:
            return UploadInitOneOf1(
                id = 1283466,
                name = 'test.jpg',
                size = 259390,
