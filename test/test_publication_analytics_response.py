...
class TestPublicationAnalyticsResponse(unittest.TestCase):
    """PublicationAnalyticsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicationAnalyticsResponse:
        """Test PublicationAnalyticsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicationAnalyticsResponse`
        """
        model = PublicationAnalyticsResponse()
        if include_optional:
            return PublicationAnalyticsResponse(
                data = [
                    postmypost_rest_sdk.models.publication_analytics.PublicationAnalytics(
                        ...
                        attaches = [
                            postmypost_rest_sdk.models.attachment.Attachment()
                            ], )
                    ]
            )
        else:
    ...
    def testPublicationAnalyticsResponse(self):
        """Test PublicationAnalyticsResponse"""
