...
class TestPublicationEdit(unittest.TestCase):
    """PublicationEdit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicationEdit:
        """Test PublicationEdit
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicationEdit`
        """
        model = PublicationEdit()
        if include_optional:
