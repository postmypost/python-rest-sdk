...
class TestAccountConnectionStatusEnum(unittest.TestCase):
    """AccountConnectionStatusEnum unit test stubs"""
    ...
    def testAccountConnectionStatusEnum(self):
        """Test AccountConnectionStatusEnum"""
        # inst = AccountConnectionStatusEnum()
