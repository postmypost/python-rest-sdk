...
class TestPublicationDetailXReplySettingsEnum(unittest.TestCase):
    """PublicationDetailXReplySettingsEnum unit test stubs"""
    ...
    def testPublicationDetailXReplySettingsEnum(self):
        """Test PublicationDetailXReplySettingsEnum"""
        # inst = PublicationDetailXReplySettingsEnum()
