...
class TestInitUploadByUrlRequest(unittest.TestCase):
    """InitUploadByUrlRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitUploadByUrlRequest:
        """Test InitUploadByUrlRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitUploadByUrlRequest`
        """
        model = InitUploadByUrlRequest()
        if include_optional:
            return InitUploadByUrlRequest(
                project_id = 56,
                url = ''
            )
        else:
    ...
    def testInitUploadByUrlRequest(self):
        """Test InitUploadByUrlRequest"""
