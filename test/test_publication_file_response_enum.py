...
class TestPublicationFileResponseEnum(unittest.TestCase):
    """PublicationFileResponseEnum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicationFileResponseEnum:
        """Test PublicationFileResponseEnum
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicationFileResponseEnum`
        """
        model = PublicationFileResponseEnum()
        if include_optional:
            return PublicationFileResponseEnum(
                id = 123456,
    ...
    def testPublicationFileResponseEnum(self):
        """Test PublicationFileResponseEnum"""
