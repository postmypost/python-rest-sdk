...
class TestPublicationDetailYouTubePrivacyStatusEnum(unittest.TestCase):
    """PublicationDetailYouTubePrivacyStatusEnum unit test stubs"""
    ...
    def testPublicationDetailYouTubePrivacyStatusEnum(self):
        """Test PublicationDetailYouTubePrivacyStatusEnum"""
        # inst = PublicationDetailYouTubePrivacyStatusEnum()
