...
class RubricsApi:
    ...
    def get_rubrics(
        ...
        _param = self._get_rubrics_serialize(
    ...
    @validate_call
    def get_rubrics_with_http_info(
        self,
        project_id: Annotated[StrictInt, Field(description="Project ID")],
        sort: Annotated[Optional[StrictStr], Field(description="List sorting parameter. Format: `sort=field` — ascending by field, `sort=-field` — descending by field. Multiple fields can be specified separated by a comma: `sort=field,-another_field`. ")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Page number (starts from 1).")] = None,
    ...
    @validate_call
    def get_rubrics_without_preload_content(
        self,
        project_id: Annotated[StrictInt, Field(description="Project ID")],
        sort: Annotated[Optional[StrictStr], Field(description="List sorting parameter. Format: `sort=field` — ascending by field, `sort=-field` — descending by field. Multiple fields can be specified separated by a comma: `sort=field,-another_field`. ")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Page number (starts from 1).")] = None,
