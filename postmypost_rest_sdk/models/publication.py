...
class Publication(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="Publication ID")
    ...
    account_ids: List[StrictInt] = Field(description="List of account IDs where the post will be published")
    details: List[PublicationDetail] = Field(description="Publication details for each account or account group")
    publication_status: PublicationStatusEnum
    __properties: ClassVar[List[str]] = ["id", "post_at", "delete_at", "rubric_id", "account_ids", "details", "publication_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": [PublicationDetail.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
