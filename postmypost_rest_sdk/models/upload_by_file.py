...
class UploadByFile(BaseModel):
    """
    Parameters required for direct file upload to storage (e.g., S3).
    """ # noqa: E501
    id: StrictInt = Field(description="Upload ID")
    name: StrictStr = Field(description="File name")
    size: StrictInt = Field(description="File size in bytes")
    action: StrictStr = Field(description="Upload endpoint URL")
    fields: List[UploadByFileFieldsInner] = Field(description="Parameters to be submitted with the file during upload")
    status: UploadStatusEnum
    __properties: ClassVar[List[str]] = ["id", "name", "size", "action", "fields", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fields": [UploadByFileFieldsInner.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
