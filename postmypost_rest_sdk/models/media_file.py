...
class MediaFile(BaseModel):
    ...
    """ # noqa: E501
    width: Optional[StrictInt] = Field(default=None, description="File width in pixels")
    height: Optional[StrictInt] = Field(default=None, description="File height in pixels")
    url: Optional[StrictStr] = Field(default=None, description="URL to download or view the file")
