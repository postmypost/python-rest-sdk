...
class PublicationAnalytics(BaseModel):
    ...
    attaches: List[Attachment] = Field(description="Array of attachments")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attaches": [Attachment.from_dict(_item) for _item in obj["attaches"]] if obj.get("attaches") is not None else None
        })
        return _obj
