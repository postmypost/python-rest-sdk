...
class PublicationAnalytics(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Publication ID")
    external_id: Optional[StrictStr] = Field(default=None, description="Chanel publication ID")
    external_url: StrictStr = Field(description="Chanel publication URL")
    created_at: datetime = Field(description="Post creation date and time")
    content: Optional[StrictStr] = Field(default=None, description="Post text")
    analytics: Dict[str, Union[StrictFloat, StrictInt]] = Field(description="Metrics for the post (e.g. views, likes, comments, etc.)")
    attaches: List[Optional[Attach]] = Field(description="Array of attachments")
    __properties: ClassVar[List[str]] = ["id", "external_id", "external_url", "created_at", "content", "analytics", "attaches"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in attaches (list)
        _items = []
        if self.attaches:
            for _item in self.attaches:
                if _item:
                    _items.append(_item.to_dict())
            _dict['attaches'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attaches": [Attach.from_dict(_item) for _item in obj["attaches"]] if obj.get("attaches") is not None else None
        })
        return _obj
