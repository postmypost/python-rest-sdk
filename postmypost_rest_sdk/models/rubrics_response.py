...
class RubricsResponse(BaseModel):
    ...
    data: List[Rubric]
    pages: Pagination
    __properties: ClassVar[List[str]] = ["data", "pages"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Rubric.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "pages": Pagination.from_dict(obj["pages"]) if obj.get("pages") is not None else None
        })
        return _obj
