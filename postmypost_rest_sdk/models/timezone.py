...
class Timezone(BaseModel):
    ...
    Timezone
    """ # noqa: E501
    id: StrictInt = Field(description="Timezone ID")
    name: StrictStr = Field(description="Timezone name")
    utc_offset: Union[StrictFloat, StrictInt] = Field(description="Offset relative to UTC+0")
    __properties: ClassVar[List[str]] = ["id", "name", "utc_offset"]
