...
class ImageAttachment(BaseModel):
    ...
    image: MediaFile
    preview: MediaFile
    __properties: ClassVar[List[str]] = ["type", "image", "preview"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "image": MediaFile.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "preview": MediaFile.from_dict(obj["preview"]) if obj.get("preview") is not None else None
        })
        return _obj
