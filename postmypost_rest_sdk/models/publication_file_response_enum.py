...
class PublicationFileResponseEnum(BaseModel):
    """
    Object representing a file attached to a publication
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="File ID")
    original: Optional[StrictStr] = Field(default=None, description="File URL")
    __properties: ClassVar[List[str]] = ["id", "original"]
