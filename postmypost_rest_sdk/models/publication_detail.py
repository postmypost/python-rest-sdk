...
class PublicationDetail(BaseModel):
    ...
    comment: Optional[StrictStr] = Field(default=None, description="First comment")
    ...
    __properties: ClassVar[List[str]] = ["account_id", "content", "comment", "link", "title", "tiktok_comment", "tiktok_duet", "tiktok_stitch", "tiktok_privacy_status", "files", "publication_type"]
