...
class Account(BaseModel):
    ...
    chanel_id: StrictInt = Field(description="Channel ID")
    external_id: StrictStr = Field(description="Account ID in the channel")
    name: StrictStr = Field(description="Account name")
    login: Optional[StrictStr] = Field(default=None, description="Account login")
    connection_status: AccountConnectionStatusEnum
    __properties: ClassVar[List[str]] = ["id", "chanel_id", "external_id", "name", "login", "connection_status"]
