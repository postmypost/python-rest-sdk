...
class UploadInitOneOf1(BaseModel):
    """
    UploadInitOneOf1
    """ # noqa: E501
    ...
    action: StrictStr = Field(description="Upload URL")
    fields: List[UploadInitOneOf1FieldsInner] = Field(description="Parameters to be sent with the file upload")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fields": [UploadInitOneOf1FieldsInner.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
